...
public partial class CMSModules_PageBuilderContainers_Controls_PageBuilderContainers_General : CMSPreviewControl
{
    #region "Variables"
    ...
    {
        previewState = GetPreviewStateFromCookies("pbc");
